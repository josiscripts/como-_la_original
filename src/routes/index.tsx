...
const placeholderExamples = [
  "Tengo antojo de Oreo...",
  "Tengo antojo de KitKat...",
  "Tengo antojo de donuts...",
    ...
    <main>
      <section className="relative m-0 flex h-[100svh] min-h-[100svh] w-full items-center justify-center overflow-hidden px-0 pb-6 pt-[92px] sm:pb-8 sm:pt-[104px]">
        ...
        >
          ...
          <p className="mx-auto max-w-[32ch] text-[0.95rem] text-muted-foreground sm:max-w-xl sm:text-base lg:text-lg">
            Dinos tu capricho y encontramos una alternativa que puedas disfrutar.
          </p>
          ...
          <div className="mx-auto w-full max-w-xl">
            <DietaryFilter
              ...
              onChange={setNeed}
              layout="pills"
              legend="¿Tienes alguna restricción?"
